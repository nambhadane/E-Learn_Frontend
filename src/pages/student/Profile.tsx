import { BookOpen, FileText, Trophy, Bell, User as UserIcon, Mail, Hash } from "lucide-react";
          ...
          <Card className="p-6 shadow-card">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="text-center p-4 bg-secondary rounded-lg">
                <p className="text-2xl font-bold text-foreground">{studentData.stats.enrolledClasses}</p>
                <p className="text-sm text-muted-foreground">Classes</p>
              </div>
              <div className="text-center p-4 bg-secondary rounded-lg">
                <p className="text-2xl font-bold text-foreground">{studentData.stats.pendingAssignments}</p>
                <p className="text-sm text-muted-foreground">Pending</p>
              </div>
              <div className="text-center p-4 bg-secondary rounded-lg">
                <p className="text-2xl font-bold text-foreground">{studentData.stats.gradesReceived}</p>
